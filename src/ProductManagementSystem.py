...
class ProductManagementSystem:
    def __init__(self, root):
        ...
        # Add Button
        self.button_add = tk.Button(text="Add product", width=22, command=self.OpenAddProductWindow)
        self.button_add.pack(pady=5)

        # Edit Button
        self.button_edit = tk.Button(text="Edit Product", width=22, command=self.OpenEditProductWindow)
