...
class ProductManagementSystem:
    def __init__(self, root):
        ...
        # Delete Button
        self.button_delete = tk.Button(delete_frame, text="Delete", command=lambda:self.delete_product)
        self.button_delete.pack(side=tk.LEFT)

        # Add Button
        self.button_add = tk.Button(text="Add product", width=22, command=lambda: self.OpenAddProductWindow())
        self.button_add.pack(pady=5)

        # Edit Button
        self.button_edit = tk.Button(text="Edit Product", width=22, command=lambda:self.OpenEditProductWindow)
