...
def test_filter_by_meals_category(setup_test_db):
...
def test_filter_by_snacks_category(setup_test_db):
...
def test_filter_by_drinks_category(setup_test_db):
...
def test_transaction_saves_with_date(setup_test_db):
...
def test_stock_decreases_after_transaction(setup_test_db):
...
def test_cancel_does_not_affect_stock(setup_test_db):
